  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-white">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative bg-[#0B1120] overflow-hidden flex-col items-center justify-center p-12">
        ...
        <div className="relative z-10 w-full max-w-sm flex flex-col items-start px-4 -mt-24">
          <Image 
      ...
      {/* Right Panel */}
      <div className="flex-1 flex flex-col justify-center items-center p-8 sm:p-12 lg:p-24 bg-white overflow-hidden">
