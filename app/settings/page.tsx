        ...
        <div className="md:col-span-2 space-y-6">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="flex items-center gap-6 mb-6">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900">User Telkom</h3>
                <p className="text-gray-500">user@telkom.co.id</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" defaultValue="User Telkom" className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-telkom-red focus:border-transparent" readOnly />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                <input type="email" defaultValue="user@telkom.co.id" className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-telkom-red focus:border-transparent bg-gray-50" readOnly />
              </div>
            </div>
          </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-4">
              <div className="flex justify-between items-end mb-2">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900 mt-1">3 / 3 <span className="text-base font-normal text-gray-500">Left</span></p>
                </div>
              </div>
